  ...
  <div class="homepage-focus" nctype="sellerTplContent">
    ...
    <form class="tab-content" method="post" name="short_name" style="display:none;">
      ...
      <table class="table tb-type2">
        <tbody>
          <tr class="noborder">
            <td colspan="2" class="required"><label>手机短信开关:</label><label style="margin-left: 2rem">阿里云ID:</label></td>			
          </tr>
          <tr class="noborder">
            <td class="vatop rowform onoff">
