...
class member_inviteControl extends mobileMemberControl {
    ...
    public function indexOp() {
	    ...
	    $myurl=BASE_SITE_URL."/#V3".$encode_member_id;
		...
		$watermark->watermarkOp($member_id);
		...
		$member_info['myurl_wxchasrc']=UPLOAD_SITE_URL.DS."shop".DS."member/wxcha".DS."member_2_".$member_id.'.jpg';
    ...
    public function inviteoneOp() {
		...
		{
				$list[$key]['member_time'] = date('Y-m-d H:i:s', $val['member_time']);
			//获取佣金订单数量
