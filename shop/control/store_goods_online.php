...
class store_goods_onlineControl extends BaseSellerControl {
    ...
    public function edit_save_goodsOp() {
        ...
        $update_common = array();
        $update_common['goods_name']         = $_POST['g_name'];		$update_common['goods_commissionone']         = $_POST['goods_commissionone'];		$update_common['goods_commissiontwo']         = $_POST['goods_commissiontwo'];
        ...
        if (is_array ( $_POST ['spec'] )) {
            foreach ($_POST['spec'] as $value) {
                ...
                if (!empty($goods_info)) {
                    ...
                    $update['goods_name']        = $update_common['goods_name'] . ' ' . implode(' ', $value['sp_value']);					$update['goods_commissionone']         = $update_common['goods_commissionone'];					$update['goods_commissiontwo']         = $update_common['goods_commissiontwo'];
		    ...
		    // 生成商品二维码
                    ...
                    $insert['goods_name']        = $update_common['goods_name'] . ' ' . implode(' ', $value['sp_value']);					$insert['goods_commissionone']         = $update_common['goods_commissionone'];					$insert['goods_commissiontwo']         = $update_common['goods_commissiontwo'];
