...
<div class="item-publish">
  <form method="post" id="goods_form" action="<?php if ($output['edit_goods_sign']) { echo urlShop('store_goods_online', 'edit_save_goods');} else { echo urlShop('store_goods_add', 'save_goods');}?>">
    ...
    <div class="ncsc-form-goods">
      ...
      </dl>	  	   <dl>        <dt>一级佣金</dt>        <dd>          <input name="goods_commissionone" value="<?php echo $output['goods']['goods_commissionone']; ?>" type="text" class="text w60" /><em class="add-on">%</em> <span></span>          <p class="hint"></p>        </dd>      </dl>	  	  <dl>        <dt>二级佣金</dt>        <dd>          <input name="goods_commissiontwo" value="<?php echo $output['goods']['goods_commissiontwo']; ?>" type="text" class="text w60" /><em class="add-on">%</em> <span></span>          <p class="hint"></p>        </dd>      </dl>
      <dl>
