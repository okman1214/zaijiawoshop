        ...
        foreach ($store_cart_list as $store_id => $goods_list) {
            ...
            foreach ($goods_list as $goods_info) {
                ...
                if (!intval($goods_info['bl_id'])) {
                    ...
                    $order_goods[$i]['store_id'] = $store_id;				//分销佣金					$goods_idarr=array();					$goods_idarr['goods_id'] =$goods_info['goods_id'];					$model_goodsinfo=$model_goods->getGoodsInfo($goods_idarr);										$order_goods[$i]['invite_rates'] = floatval($goods_info['goods_price'] * $model_goodsinfo['goods_commissionone'] / 100);					$order_goods[$i]['invite_ratestwo'] = floatval($goods_info['goods_price'] * $model_goodsinfo['goods_commissiontwo'] / 100);
