...
class orderLogic {
    ...
    public function changeOrderSend($order_info, $role, $user = '', $post = array()) {		        
        ...
        $param['param'] = array(
            'order_sn' => $order_info['order_sn'].$post['deliver_explain'],			
