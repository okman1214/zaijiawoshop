...
class evaluateControl extends BaseHomeControl{
    ...
    public function indexOp(){
        ...
        if (!$_POST){
            ...
            Tpl::showpage('evaluation.add');//die;
        }
    }

    public function evaluation_addOp(){
    	$order_id = intval($_GET['order_id']);
    	$model_order = Model('order');
        $model_store = Model('store');
        $model_evaluate_goods = Model('evaluate_goods');
...
//             //添加店铺评价
            ...
            showDialog('完成评价','./tmpl/member/order_list.html', 'succ');
