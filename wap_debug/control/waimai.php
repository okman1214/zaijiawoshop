...
class waimaiControl extends BaseHomeControl {
    ...
    public function fabu(){
    	Tpl::showpage('work_fabu');
    }
    public function work_listOp(){
    	$condition['cat_id'] = intval($_GET['cat_id']);

    	$model = Model();
    	$worker_list = $model->table('zhaopin')->where($condition)->order('zp_stime')->select();
