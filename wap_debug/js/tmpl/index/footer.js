...
//and
  ...
  +'<div id="nav-tab" style="bottom:-40px;">'
      ...
      +'<div class="tab-line-item tab-categroy" style="width:19%;" ><i class="kefu"><a href="http://wpa.qq.com/msgrd?v=3&uin=1804533648&site=qq&menu=yes"><img src="'+WapSiteUrl+'/images/kf.png" width="25%"></i><br>客服</a></div>'
	   +'<div class="tab-line-item tab-categroy" style="width:19%;" ><a href="'+WapSiteUrl+'/special.html?special_id=4"><i class="list"><img src="'+WapSiteUrl+'/images/gj.png" width="25%"></i><br>微论坛</a></div>'
