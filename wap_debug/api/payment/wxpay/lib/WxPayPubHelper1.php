...
class Common_util_pub
{
	...
	{
		//error_log('data:'.date('Y-m-d H:i:s',time())."\n".var_export($paraMap,1)."\n",3,'D:/www/lqsh/mobile/lo.txt');
		//error_log('data:'.date('Y-m-d H:i:s',time())."\n".var_export($urlencode,1)."\n",3,'D:/www/lqsh/mobile/2.txt');
		$buff = "";
		ksort($paraMap);
