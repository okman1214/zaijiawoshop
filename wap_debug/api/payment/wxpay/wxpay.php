...
//error_log('data:'.date('Y-m-d H:i:s',time())."\n".var_export($prepay_id,1)."\n",3,'D:/www/lqsh/mobile/log1.txt');
//=========步骤3：使用jsapi调起支付============
$jsApi->setPrepayId($prepay_id);

$jsApiParameters = $jsApi->getParameters();
//error_log('data:'.date('Y-m-d H:i:s',time())."\n".var_export($jsApiParameters,1)."\n",3,'D:/www/lqsh/mobile/log5.txt');
