...
.invite-bd { background: url('<?php echo SHOP_TEMPLATES_URL;?>/images/invite/center3.jpg') no-repeat; height: 600px; }
.invite-rules { width:98%; position:relative; top:160px; left:5px; color: #5d3701; line-height: 24px; font-size: 14px; padding: 10px 4px; background: #fff;}
.invite-form { background: #fffeec; height: 102px; margin: 0px 0 0 0px; position: absolute; width: 100%; }
.invite-form .i-invite-link { background-color: #fff; border: 1px solid #bbb; color: #000; padding:0 4px; color: #000; font-size: 1.25em; height: 45px; line-height: 45px; vertical-align: middle; width: 60%; }
.invite-form .invite-text { color:#fd6208; margin-left:5px; font-size:18px; }
.invite-form div { margin-left:5px; }
...
.copy-btn { font-size: 28px; height: 32px; line-height: 32px; width: 15%; background-color: #fa6515; }
.invite-share-site { position: relative; top: 140px; left:1%; width: 98%;background: #fff; }
.invite-rebate { position: relative; top: 160px; left: 8%; width: 10%; }
.invite-join-dashi { left: ; position: relative; top: 420px; width: 100px; }
    ...
    <div class="span-24" id="content">
      <div class="invite-bd ">
        ...
        <div class="invite-share-site clearfix"> 
          <!-- Baidu Button BEGIN -->
          <p id="bdshare" class="bdshare_t bds_tools get-codes-bdshare" data="{'url':'<?php echo BASE_SITE_URL;?>/'}"> <span class="bds_more">快捷邀请：</span> <a class="bds_qzone">QQ空间</a> <a class="bds_tsina">新浪微博</a> <a class="bds_tqq">腾讯微博</a> <a class="bds_taobao">我的淘宝</a> <a class="bds_renren">人人网</a> <a class="bds_douban">豆瓣</a> </p>
          <!-- Baidu Button END --> 
        </div>
