...
<div class="pubMust">
	<form method="post" name="fm" action="<?php echo WAP_SITE_URL.'/index.php?act=live&op=live_house_contri_add';?>" onsubmit ="getElementById('submitInput').disabled=true;return true;">
	<div class="">
	<ul>
	<li><label>发布类型:</label>
...
if(!is_weixin() ){
$('#as').diyUpload({
	url:'<?php echo WAP_SITE_URL.'/index.php?act=live&op=flea_image_upload';?>',
